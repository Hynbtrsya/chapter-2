...
public class DiscountSeason {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Price per Item: " + price); // Output the price per item
        System.out.println("Quantity: " + quantity); // Output the quantity of items
        System.out.println("Total Price: " + totalPrice); // Output the total price before discount
        System.out.println("Discount Rate: " + discountRate + "%"); // Output the discount rate
        System.out.println("Price after Discount: " + finalPrice); // Output the final price after discount
